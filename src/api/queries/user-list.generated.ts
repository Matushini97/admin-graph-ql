...
export const GetUsersDocument = gql`
    query GetUsers($pageSize: Int = 10, $pageNumber: Int = 1, $sortDirection: SortDirection = desc, $sortBy: String = "createdAt", $searchTerm: String, $statusFilter: UserBlockStatus = ALL) {
  getUsers(
    pageSize: $pageSize
